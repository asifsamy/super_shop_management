...
namespace Supershop
{
    ...
    {
        private readonly ProductSaleController pdSaleController;
        ...
        {
            InitializeComponent();
            pdSaleController = new ProductSaleController();
            loadData();
        }
        ...
        private void dataGridView1_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            if (e.RowIndex >= 0)
            {
                ...
                if (f == 0)
                {
                    if (pdSaleController.checkAvailability(Convert.ToInt32(row.Cells["product_available"].Value.ToString())))
                    {
